classdef FMM<handle
    ...
    methods
        ...
        function obj = FMM(wf,K,maxClusters)
            % class constructor
            if(nargin > 0)
                obj.waveforms=wf;
            end
        ...
        function f=drawPCA3d(obj,fignum,flag)
            if nargin<2
                fignum=1;
            end
            if nargin<3
        ...
        function f=drawClusters(obj,fignum)
